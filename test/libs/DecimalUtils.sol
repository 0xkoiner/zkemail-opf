...
library DecimalUtils {
    ...
    /// @return string representation of value with decimal places
    function uintToDecimalString(uint256 value, uint256 decimal) public pure returns (string memory) {
        ...
        uint256 delta = valueLength > decimal ? 1 : resultLength - valueLength;
